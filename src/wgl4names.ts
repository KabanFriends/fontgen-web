// The 258 standard Macintosh glyph names, as used by FontBox's WGL4Names for
// 'post' table formats 1 and 2. Order is significant (index = standard mac glyph id).

export const MAC_GLYPH_NAMES: readonly string[] = [
...
export const NUMBER_OF_MAC_GLYPHS = MAC_GLYPH_NAMES.length; // 258
